    ...
    <main className="max-w-5xl mx-auto px-6 py-10 space-y-8">
      ...
      {msg && (
        <div className={`px-4 py-3 rounded-xl border text-sm ${
          msg.type === "success" ? "text-green-400 bg-green-950/40 border-green-800" : "text-red-400 bg-red-950/40 border-red-800"
        }`}>{msg.text}</div>
      )}
      ...
      <div className="grid md:grid-cols-3 gap-5">
        {PLANS.map(plan => {
          ...
          return (
            <div key={plan.id} className={`relative rounded-2xl border p-6 flex flex-col gap-4 transition-all ${
              isCurrent ? "border-blue-500 bg-blue-950/10" : plan.hot ? "border-blue-600/50 bg-gray-900" : "border-gray-800 bg-gray-900"
            }`}>
              {plan.hot && !isCurrent && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full text-xs font-bold bg-blue-600 text-white">Populaire</div>
              )}
              {isCurrent && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full text-xs font-bold bg-green-600 text-white">Plan actuel</div>
              )}
              <div>
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-8">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-5 flex items-center justify-between">
          ...
          {currentPlan !== "starter" ? (
            <span className="text-xs text-green-400 bg-green-950/50 border border-green-800 px-3 py-1 rounded-full">
              ✓ Abonnement actif
            </span>
          ) : (
          ...
          {PLANS.map(plan => {
            ...
            return (
              <div
                ...
                className={`relative rounded-2xl border p-6 flex flex-col gap-4 transition-all ${
                  isCurrent
                    ...
                    : plan.hot
                    ? "border-blue-600/50 bg-gray-900"
              ...
              >
                ...
                {isCurrent && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full text-xs font-bold bg-green-600 text-white">
                    Plan actuel
                  </div>
                )}
