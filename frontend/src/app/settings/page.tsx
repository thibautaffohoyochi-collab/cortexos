...
type UsageData = {
  ...
  usage: { messages: UsageStat; sources: UsageStat; workflows: UsageStat; members: UsageStat }
}
type Memory = {
    ...
    fetch(`${API}/settings/usage`, { headers: { Authorization: `Bearer ${token}` } })
      ...
      .then(data => {
        ...
        if (data && data.usage) {
          ...
          // Ancien format — conversion compatible
          setUsage({
            plan: "starter", plan_label: "Starter", plan_price: 0,
        ...
        {usage && (
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-5">
            ...
            <div className="space-y-4">
              ...
              <UsageBar label="Membres équipe" icon="👥" stat={usage.usage.members} />
            </div>
                  ...
                  <div>
                    {usage.plan === "starter" ? (
                      <>
                        ...
                        <p className="text-xs text-gray-400 mt-0.5">Messages illimités, web search, veille — 29€/mois</p>
                      </>
                    ) : (
                      <>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          ...
          <div className="space-y-2 text-sm text-gray-400">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-white font-medium">{usage?.plan_label ?? "—"}</span>
            </div>
          </div>
        </div>
